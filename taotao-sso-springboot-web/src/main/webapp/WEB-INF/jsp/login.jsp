...
<div class="w">
    <div id="logo">
    	<a href="http://portal.taotao.com" clstag="passport|keycount|login|01">
...
<form id="formlogin" method="post" onsubmit="return false;">
    <div class=" w1" id="entry">
        ...
        <div class="free-regist">
            <span><a href="javascript:LOGIN.register();" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<script type="text/javascript">
	...
	var LOGIN = {
			...
			doLogin:function() {
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						alert("登录成功！");
						if (redirectUrl == "") {
							location.href = "http://portal.taotao.com";
						} else {
			...
			register:function(){
				if (redirectUrl == "") {
					...
					location.href = "/page/register?redirect=" + redirectUrl;
				}
				return false;
			}
