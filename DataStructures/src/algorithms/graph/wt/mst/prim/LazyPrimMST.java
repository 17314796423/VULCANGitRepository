...
import data.structures.heap.BinaryMinHeap;
...
public class LazyPrimMST<Weight extends Number & Comparable> {
    ...
    private BinaryMinHeap<Edge<Weight>> pq;   // 最小堆, 算法辅助数据结构
    ...
    public LazyPrimMST(WeightedGraph<Weight> graph){
        ...
        // 算法初始化
        G = graph;
        pq = new BinaryMinHeap<Edge<Weight>>(G.E());
