...
import data.structures.tree.union_find.UnionFindPathCompressed;
...
public class KruskalMST<Weight extends Number & Comparable> {
    ...
    public KruskalMST(WeightedGraph graph){
        ...
        // 将图中的所有边存放到一个最小堆中
        BinaryMinHeap<Edge<Weight>> pq = new BinaryMinHeap<Edge<Weight>>( graph.E() );
        ...
        UnionFindPathCompressed uf = new UnionFindPathCompressed(graph.V());
