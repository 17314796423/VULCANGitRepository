package algorithms.graph.wt.mst.kruskal;

import algorithms.graph.wt.ReadWeightedGraph;
import algorithms.graph.wt.SparseWeightedGraph;
import algorithms.graph.wt.mst.prim.LazyPrimMST;
import algorithms.graph.wt.mst.prim.PrimMST;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String filename1 = "testG1_wt.txt";
        int V1 = 8;

        String filename2 = "testG2_wt.txt";
        int V2 = 250;

        String filename3 = "testG3_wt.txt";
        int V3 = 1000;

        String filename4 = "testG4_wt.txt";
        int V4 = 10000;
