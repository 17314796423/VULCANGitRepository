...
//        BinaryMaxHeapRev<? extends Comparable> heap = new BinaryMaxHeapRev(arr);
//        for (int i = arr.length - 1; i >= 0; i--)
//            arr[i] = heap.extractMax();
        //测试change
        BinaryMaxHeapRev<Integer> heap = new BinaryMaxHeapRev(arr);
        int _i = 0;
    ...
    public static void main(String[] args) {
        ...
        SortTestHelper.testSort("algorithms.sort.heap.index.BinaryMaxHeapRev", arr);
    }
