...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SortTestHelper.testSort("algorithms.sort.insertion.sort.InsertionSort", arr1);
        SortTestHelper.testSort("algorithms.sort.selection.sort.SelectionSort", arr2);
        SortTestHelper.testSort("algorithms.sort.selection.sort.SelectionSort2", arr3);
