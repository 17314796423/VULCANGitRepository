 ...
 */
function login() {
    return location.href = "http://sso.taotao.com/page/login?redirect=" + window.location.href;
}
function regist() {
    return location.href = "http://sso.taotao.com/page/register?redirect=" + window.location.href;
}
