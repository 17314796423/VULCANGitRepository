...
<div class="w w1 header clearfix">
    <div id="logo"><a href="http://portal.taotao.com"><img src="/images/taotao-logo.gif" alt="淘淘商城"></a></div>
</div>
...
<div class="step-tit">
	<h3>送货清单</h3>
	<div class="extra-r">
					<a href="http://cart.taotao.com/cart/cart.html" id="cartRetureUrl" class="return-edit ftx-05">返回修改购物车</a>
			</div>
</div>
    ...
    <div class="goods-suit goods-last">
	 <c:forEach items="${cartList }" var="cart">
		<div class="goods-item goods-item-extra">
			...
			<div class="p-img">
				<a target="_blank" href="http://item.taotao.com/item/${cart.id}.html">
