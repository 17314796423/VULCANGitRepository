...
<div class="clr"></div>
<div class="m clearfix" id="top_pager">
	<div  id="top_pagi" class="pagin fr" clstag="search|keycount|search|pre-page2">
	...
	<span class="page-skip"><em>&nbsp;&nbsp;共${totalPages}页&nbsp;&nbsp;&nbsp;&nbsp;到第<input class="jumpto" />页</em></span> --%>
	</div>
</div>
...
SEARCH.query = "${query}";
SEARCH.top_page_html(${page},${totalPages},'','');
