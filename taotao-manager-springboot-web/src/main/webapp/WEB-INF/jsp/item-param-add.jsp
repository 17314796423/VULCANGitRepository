...
<script style="text/javascript">
	$(function() {
		...
		$("#itemParamAddTable .submit").click(function(){
			if($("#itemParamAddTable [name='cid']").val() == null||$("#itemParamAddTable [name='cid']").val().trim() == ''){
				$.messager.alert("提示", "请选择类目。", undefined, function() {
							$("#itemParamAddTable .selectItemCat").click();
				});
				return;
			}
			...
			$.ajax({
				async:false,
				url:"/itemParam/query/" + $("#itemParamAddTable [name='cid']").val(),
